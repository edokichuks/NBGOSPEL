...
import 'package:nbgospel/screen/about_developers.dart';
...
class Developer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ThemeModel>(
      ...
      return Card(
        elevation: height / 50,
        color: themeNotifier.isDark ? Colors.grey[900] : Colors.white,
        shadowColor: themeNotifier.isDark ? Colors.grey[900] : Colors.blueGrey,
